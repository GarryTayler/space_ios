...
import { Dimensions, Image, BackHandler, View, TouchableOpacity, TouchableHighlight , Keyboard } from 'react-native';
import { Container, Item, Input , Text , Button , CheckBox , Content, Form, ActionSheet } from 'native-base';
...
class AddressRequest extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            loaded: true,
            isAddressAlreadyExist: false, isSameAddress: false,
    ...
    onRegAddrConfButtonPressed() {
        ...
        regAddrSuccessDialogVisible = false;
        performNetwork(this, this.state.params.homeComp, register_address(
    ...
    moveToRequestServicePage() {
        ...
        Actions.push('request_service', { params: params }, { homeComp: this.state.params.homeComp });
    }
        ...
        return (
            <Container>
                        ...
                        <Form style={form.styleForm}>
                            { this.state.isAddressAlreadyExist ?
                                <TouchableHighlight activeOpacity={ 0.9 } underlayColor='#eee' style={{ padding: 8, paddingLeft: 0 }}
                                    ...
                                    <View style={[{ display:'flex' , flexDirection:'row' , alignItems: 'center' }]}>
                                        <CheckBox checked={ this.state.isSameAddress } color="#27cccd" style= {{marginLeft: -7}} onPress={ () => { this.sameAddressCheck() } } />
                            ...
                            <Item rounded style={ this.state.addr2Error != null ? form.item_common_failed : form.item_common }>
                                ...
                                { this.state.addressError != null ?
                                    <View style={{flex: 1, flexDirection: 'column' , position: 'absolute' , top: 45}} >
                ...
                <Dialog
                    ...
                    onHardwareBackPress={ () => { this.setState({ regAddrSuccessDialogVisible: false }); }}
                    footer={
                    ...
                    <DialogContent>
                        ...
                        <Form>
                            ...
                            나의 주소에 등록되었으며, 마이페이지에서 주소지 수정이 가능합니다.
                            </Text>
                        </Form>
                    </DialogContent>
                </Dialog>
...
export default connect(null, mapDispatchToProps)(AddressRequest);
