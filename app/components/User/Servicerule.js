...
let pageTitle = '서비스 이용약관';

export default class Servicerule extends React.Component {
    constructor(props) {
        super(props);
    }
    render() {
        return (
            <Container>
                ...
                <Content style={[base.whiteBg , {paddingLeft: 15 , paddingRight: 15 , paddingTop: 20 , paddingBottom: 15}]}>
                    <View>
                        <View>
                            <Text style={[fonts.familyBold , fonts.size13 , {lineHeight: 24, color: '#177a7a'}]} >제1조(목적)</Text>
                        </View>
                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12, {lineHeight: 24, color: '#177a7a'}]}>
                                이 약관은 주식회사 여유공간 (이하 "회사")이 운영하는 모바일 어플리케이션(여유공간) 및 인터넷사이트(spare-space.co.kr) 에서 제공하는 전자상거래 관련 서비스(이하 “서비스”)를이용함 에 있어 회사와 이용자의 권리. 의무 및 책임사항을 규정함을 목적으로 합니다.
                            </Text>
                        </View>
                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                        ...
                        <View style={{marginTop: 20}}>
                            <Text style={[fonts.familyBold , fonts.size13 , {lineHeight: 24, color: '#177a7a'}]} >제2조(정의)</Text>
                        </View>
                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                            ① "회사"란 주식회사 여유공간이 재화, 용역 및 서비스
                            (이하 "서비스 등")를 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 서비스 등을 제공할 수 있도록 정한 가상의 영업장을 말하며, 아울러 모바일 어플리케이션을 영하는 사업자의 의미로도 사용합니다.
                            </Text>
                        </View>

                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                            ② "이용자"란 회사에서 제공하는 어플리케이션(이하 "앱")에 접속하여 이 약관에 따라 "회사"가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
                            </Text>
                        </View>

                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                            ③ "회원"이라 함은 "앱"에 회원등록을 한 자로서, 계속적으로
                            "회사"가 제공하는 서비스를 이용할 수 있는 자를 말합니다.
                            </Text>
                        </View>

                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                            ④ "비회원"이라 함은 회원에 가입하지 않고 “회사”가 제공하는
                            서비스를 이용하는 자를 말합니다.
                            </Text>
                        </View>
                        ...
                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                            ⑤ "보관물품"이라 함은 회원이 회사에 서비스를 요청하고
                            회사의 승인이 완료된 물품을 의미합니다.
                            </Text>
                        </View>

                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                            ⑥ 위에서 정의되지 않은 용어는 일반적인 상관례에 따릅니다.
                            </Text>
                        </View>

                        <View style={{marginTop: 20}}>
                            <Text style={[fonts.familyBold , fonts.size13 , {lineHeight: 24, color: '#177a7a'}]} >제3조 (약관 등의 명시와 설명 및 개정)</Text>
                        </View>
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            포함), 전화번호․전자우편주소, 사업자등록번호, 통신판매업
                            신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수
                            있도록 인터넷사이트(spare-space.co.kr) 초기
                            서비스화면에 게시합니다. 다만, 약관의 내용은 이용자가
                            연결화면을 통하여 볼 수 있도록 할 수 있습니다.
                            </Text>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ② “회사”는 이용자가 약관에 동의하기에 앞서 약관에 정하여져
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ...
                                」,「전자금융거래법」, 「전자서명법」,「정보통신망 이용촉진
                                및 정보보호 등에 관한 법률」,「방문판매 등에 관한 법률」,
                                「소비자기본법」 등 관련 법을 위배하지 않는 범위에서
                                이 약관을 개정할 수 있습니다.
                            </Text>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ④ “회사”가 약관을 개정할 경우에는 적용일자 및 개정사유를
                                명시하여 현행약관과 함께 인터넷사이트의 초기화면에 그
                                적용일자 7일 이전부터 적용일자 전일까지 공지합니다.
                                다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는
                                최소한 30일 이상의 사전 유예기간을 두고 공지합니다.  이
                                경우 "회사“는 개정 전 내용과 개정 후 내용을 명확하게
                                비교하여 이용자가 알기 쉽도록 표시합니다.
                            </Text>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ⑤ 회사가 약관을 개정할 경우에는 그 개정약관은 그 적용일자
                                이후에 체결되는 계약에만 적용되고 그 이전에 이미 체결된
                                계약에 대해서는 개정 전의 약관조항이 그대로 적용됩니다.
                                다만 이미 계약을 체결한 이용자가 개정약관 조항의 적용을
                                받기를 원하는 뜻을 제3항에 의한 개정약관의 공지기간 내에
                                “회사”에 송신하여 “회사”의 동의를 받은 경우에는
                                개정약관 조항이 적용됩니다.
                            </Text>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② “회사”는 재화 또는 용역의 품절 또는 기술적 사양의 변경
                                등의 경우에는 장차체결되는 계약에 의해 제공할 재화 또는
                        ...
                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① “회사”는 컴퓨터 등 정보통신설비의 보수점검․교체 및
                                고장, 통신의 두절 등의 사유가 발생한 경우에는 서비스의
                                제공을 일시적으로 중단할 수 있습니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② “회사”는 제1항의 사유로 서비스의 제공이 일시적으로
                                중단됨으로 인하여 이용자 또는 제3자가 입은 손해에 대하여
                                배상합니다. 단, “회사”의 고의 또는 과실이 없음을 입증하는
                                경우에는 그러하지 아니합니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ③ 사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로
                                서비스를 제공할 수 없게 되는 경우에는 “회사”는 제8조에
                                정한 방법으로 이용자에게 통지하고 당초 “회사”에서 제시한
                                조건에 따라 소비자에게 보상합니다.
                            </Text>
                        </View>

                        <View style={{marginTop: 20}}>
                            <Text style={[fonts.familyBold , fonts.size13 , {lineHeight: 24, color: '#177a7a'}]} >제6조(회원가입)</Text>
                        </View>

                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① 이용자는 “회사”가 정한 가입 양식에 따라 회원정보를
                                기입한 후 이 약관에 동의한다는 의사표시를 함으로서
                                회원가입을 신청합니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② “회사”는 제1항과 같이 회원으로 가입할 것을 신청한 이용자
                                중 다음 각 호에 해당하지 않는 한 회원으로 등록합니다.
                            </Text>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                1.가입신청자가 이 약관 제7조제3항에 의하여 이전에
                                회원자격을 상실한 적이 있는 경우, 다만 제7조제3항에 의한
                                회원자격 상실 후 3년이 경과한 자로서 “회사”의 회원재가입
                                승낙을 얻은 경우에는 예외로 한다.
                            </Text>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                3.기타 회원으로 등록하는 것이 “회사”의 기술상 현저히
                                지장이 있다고 판단되는 경우
                            </Text>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ...
                                기간 이내에 “회사”에 대하여 회원정보 수정 등의 방법으로
                                그 변경사항을 알려야 합니다.
                            </Text>
                        </View>
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① 회원은 “회사”에 언제든지 탈퇴를 요청할 수 있으며 “
                                회사”는 즉시 회원탈퇴를 처리합니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② 회원이 다음 각 호의 사유에 해당하는 경우, “회사”는
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                2. “회사”를 이용하여 구입한 재화 등의 대금, 기타 “회사”
                                이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지
                                않는 경우
                            </Text>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                3. 다른 사람의 “회사” 이용을 방해하거나 그 정보를
                                도용하는 등 전자상거래 질서를 위협하는 경우
                            </Text>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                4.“회사”를 이용하여 법령 또는 이 약관이 금지하거나
                                공서양속에 반하는 행위를하는 경우
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ③ “회사”가 회원 자격을 제한․정지 시킨 후, 동일한 행위가 2회
                                이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는
                                경우 “회사”는 회원자격을 상실시킬 수 있습니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ④ “회사”가 회원자격을 상실시키는 경우에는 회원등록을
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① “회사”가 회원에 대한 통지를 하는 경우, 회원이 “회사”와
                                미리 약정하여 지정한 전자우편 주소로 할 수 있습니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② “회사”는 불특정다수 회원에 대한 통지의 경우 1주일이상 “
                                회사”가 지정한 방법으로 게시함으로서 개별 통지에 갈음할
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① 이용자는 “회사”에서 다음 또는 이와 유사한 방법에 의하여
                                구매를 신청하며, “회사”는 이용자가 구매신청을 함에
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                5. 재화등의 구매신청 및 이에 관한 확인 또는 “회사”의
                                확인에 대한 동의
                            </Text>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                6. 결제방법의 선택
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② “회사”가 제3자에게 구매자 개인정보를 제공할 필요가 있는
                                경우 1) 개인정보를 제공받는 자, 2)개인정보를 제공받는
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ③ “회사”가 제3자에게 구매자의 개인정보를 취급할 수 있도록
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ①  “회사”는 제9조와 같은 구매신청에 대하여 다음 각 호에
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                2.기타 구매신청에 승낙하는 것이 “회사”기술상 현저히
                                지장이 있다고 판단하는 경우
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② “회사”의 승낙이 제12조제1항의 수신확인통지형태로
                                이용자에게 도달한 시점에 계약이 성립한 것으로 봅니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ③ “회사”의 승낙의 의사표시에는 이용자의 구매 신청에 대한
                        ...
                        <View style={{marginTop: 15}}>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                “회사”에서 구매한 재화 또는 용역에 대한 대금지급방법은
                                다음 각 호의 방법중 가용한 방법으로 할 수 있습니다. 단, “
                                회사”는 이용자의 지급방법에 대하여 재화 등의 대금에
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ...
                                취소를 요청할 수 있고 “회사”는 배송 전에 이용자의 요청이
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① “회사”는 이용자와 재화/서비스 등의 공급시기에 관하여
                                별도의 약정이 없는 이상, 이용자가 청약을 한 날부터 7일
                                이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의
                                필요한 조치를 취합니다. 다만, “회사”가 이미 재화 등의
                                대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는
                                일부를 받은 날부터 3영업일 이내에 조치를 취합니다.  이때
                                “회사”는 이용자가 재화 등의 공급 절차 및 진행 사항을
                                확인할 수 있도록 적절한 조치를 합니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② “회사”는 이용자가 구매한 재화에 대해 배송수단, 수단별
                                배송비용 부담자, 수단별 배송기간 등을 명시합니다. 만약 “
                                회사”가 약정 배송기간을 초과한 경우에는 그로 인한
                                이용자의 손해를 배상하여야 합니다. 다만 “회사”가 고의․
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                “회사”는 이용자가 구매신청한 재화 등이 품절 등의 사유로
                                인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를
                                이용자에게 통지하고 사전에 재화 등의 대금을 받은
                                경우에는 대금을 받은 날부터 5영업일 이내에 환급하거나
                                환급에 필요한 조치를 취합니다.
                            </Text>
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① “회사”와 재화등의 구매에 관한 계약을 체결한 이용자는 「
                                전자상거래 등에서의 소비자보호에 관한 법률」 제13조 제2
                                항에 따른 계약내용에 관한 서면을 받은 날(그 서면을 받은
                                때보다 재화 등의 공급이 늦게 이루어진 경우에는 재화 등을
                                공급받거나 재화 등의 공급이 시작된 날을 말합니다)부터 7
                                일 이내에는 청약의 철회를 할 수 있습니다. 다만,
                                청약철회에 관하여 「전자상거래 등에서의 소비자보호에
                                관한 법률」에 달리 정함이 있는 경우에
                                는 동 법 규정에 따릅니다.
                            </Text>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ③ 제2항제2호 내지 제4호의 경우에 “회사”가 사전에 청약철회
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ...
                                사실을 안 날 또는 알 수 있었던 날부터 30일 이내에
                                청약철회 등을 할 수 있습니다.
                            </Text>
                        </View>
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① “회사”는 이용자로부터 재화 등을 반환받은 경우 5영업일
                                이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 경우
                                “회사”는 이용자에게 재화등의 환급을 지연한때에는 그
                                지연기간에 대하여 「전자상거래 등에서의 소비자보호에
                                관한 법률 시행령」제21조의2에서 정하는 지연이자율을
                                곱하여 산정한 지연이자를 지급합니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② “회사”는 위 대금을 환급함에 있어서 이용자가 신용카드
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ...
                                회사”는 청약철회 시 그 비용을  누가 부담하는지를 이용자가
                                알기 쉽도록 명확하게 표시합니다.
                            </Text>
                        </View>
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① “ 회사”는 이용자의 개인정보 수집시 서비스제공을 위하여
                                필요한 범위에서 최소한의 개인정보를 수집합니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② “회사”는 회원가입시 구매계약이행에 필요한 정보를 미리
                                수집하지 않습니다. 다만, 관련 법령상 의무이행을 위하여
                                구매계약 이전에 본인확인이 필요한 경우로서
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ⑤ “회사”가 제2항과 제3항에 의해 이용자의 동의를 받아야
                                하는 경우에는 개인정보관리 책임자의 신원(소속, 성명 및
                                전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3
                                자에 대한 정보제공 관련사항(제공받은자, 제공목적 및
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ⑥ 이용자는 언제든지 “회사”가 가지고 있는 자신의 개인정보에
                                대해 열람 및 오류정정을 요구할 수 있으며 “회사”는 이에
                                대해 지체 없이 필요한 조치를 취할 의무를 집니다. 이용자가
                                오류의 정정을 요구한 경우에는 “회사”는 그 오류를 정정할
                                때까지 당해 개인정보를 이용하지 않습니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ⑦ “회사”는 개인정보 보호를 위하여 이용자의 개인정보를
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ⑧ “회사” 또는 그로부터 개인정보를 제공받은 제3자는
                                개인정보의 수집목적 또는 제공받은 목적을 달성한 때에는
                                당해 개인정보를 지체 없이 파기합니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ⑨ “회사”는 개인정보의 수집•이용•제공에 관한 동의 란을
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                                4. “회사”가 정한 정보 이외의 정보(컴퓨터 프로그램 등)
                                등의 송신 또는 게시
                            </Text>
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginLeft: 10}]}>
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① 상위 “회사”와 하위 “회사”가 하이퍼링크(예: 하이퍼링크의
                                대상에는 문자, 그림 및 동화상 등이 포함됨)방식 등으로
                                연결된 경우, 전자를 연결 “회사”(웹 사이트)이라고 하고
                                후자를 피연결 “회사”(웹사이트)이라고 합니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② 연결“회사”는 피연결“회사”가 독자적으로 제공하는 재화
                                등에 의하여 이용자와 행하는 거래에 대해서 보증 책임을
                                지지 않는다는 뜻을 연결“회사”의 초기화면 또는 연결되는
                        ...
                        <View style={{marginTop: 15}}>
                            ...
                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ②이용자는 “회사”를 이용함으로써 얻은 정보 중 “회사”에게
                                지적재산권이 귀속된 정보를 “회사”의 사전 승낙 없이 복제,
                                송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로
                                이용하거나 제3자에게 이용하게 하여서는 안됩니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ③ “회사”는 약정에 따라 이용자에게 귀속된 저작권을
                                사용하는 경우 당해 이용자에게 통보하여야 합니다.
                            </Text>
                        </View>

                        <View style={{marginTop: 20}}>
                            <Text style={[fonts.familyBold , fonts.size13 , {lineHeight: 24, color: '#177a7a'}]} >제23조(분쟁해결)</Text>
                        </View>

                        <View style={{marginTop: 15}}>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a'}]}>
                                ① “회사”는 이용자가 제기하는 정당한 의견이나 불만을
                                반영하고 그 피해를 보상처리하기 위하여
                                피해보상처리기구를 설치․운영합니다.
                            </Text>

                            <Text style={[fonts.familyMedium , fonts.size12 , {lineHeight: 24, color: '#177a7a' , marginTop: 10}]}>
                                ② “회사”는 이용자로부터 제출되는 불만사항 및 의견은
